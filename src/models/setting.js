...
const updateTheme = primaryColor => {
  ...
  function buildIt() {
    ...
    setTimeout(() => {
      ...
      console.log('antd-theme-generator', A);
      window.A = A;
      //TODO:这里修改主题不知为何会reject失败,可能是由于/color.less文件被重定向了
      window.less
  ...
  if (!lessNodesAppended) {
    ...
    console.log('lessStyleNode', lessStyleNode);
